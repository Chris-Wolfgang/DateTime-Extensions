...
public static class DocExampleSource
{
    ...
    {
        // One src package here. The port this came from also walked a sibling Legacy
        // package; enumerating a directory that does not exist throws, so that loop is
        // gone rather than guarded - there is nothing for it to find.
    ...
    /// <c>src/Wolfgang.Extensions.DateTime/</c>. Deliberately NOT
